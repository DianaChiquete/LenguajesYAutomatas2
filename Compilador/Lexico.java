...
public class Lexico
{
	...
	public Lexico(String dir) {
		AnalisisLexico(dir);
		if(error)
			JOptionPane.showMessageDialog(null, "Ocurrio Un Error Lexico.", "ERROR",JOptionPane.WARNING_MESSAGE);
	}
	...
	{
		if(token.equals("if")||token.equals("else")||token.equals("while")||token.equals("imprime")||token.equals("int")||token.equals("double")||token.equals("String")||token.equals("class"))
		{
			int id=0;
			switch(token){
	...
	public boolean numero(String token){
		...
		/*
		if(token.equals("1") || token.equals("2") || token.equals("3") || token.equals("4") || token.equals("5") || token.equals("6") || token.equals("7") || token.equals("8") || token.equals("9") || token.equals("0"))
		{
			PalabrasAnalizadas.add(new Token("Numero",token,fila,18));
			return true;
		}*/
